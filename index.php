  ...
  <body>
    ...
    <main>
      ...
      <section class="container-fluid">   
       ...
       <!-- card vendeur -->  
        <div class="col-12 col-lg-6 col-xl-4 col-md-2 order-md-1 order-lg-1 responsive0"> 
          <div class="card card-vendeur box-Sha mx-auto">
              ...
              <div class="card-text m-4 police2">
                ...
                <div class="card bg-light mb-3 d-none" style="max-width: 10rem;" id="cardRating">
                  ...
                  <div class="card-body police1">
                    <h5 class="card-title ">65 évaluations</h5>
                    <p class="card-text fw-bold">2,3 sur 5</p>
                  </div>
                </div>
            ...
            <div id="wrapper-9cd199b9cc5410cd3b1ad21cab2e54d3">
              <div id="map-9cd199b9cc5410cd3b1ad21cab2e54d3"></div><script>(function () {
                  var setting = {"height":385,"width":803,"zoom":17,"queryString":"7 Boulevard des Minimes, Toulouse, France","place_id":"ChIJNbQcQKS8rhIRqPHisX3C7tA","satellite":false,"centerCoord":[43.614944415130495,1.4494223999999978],"cid":"0xd0eec27db1e2f1a8","lang":"fr","cityUrl":"/france/toulouse","cityAnchorText":"Carte de Toulouse, Sud de la France, France","id":"map-9cd199b9cc5410cd3b1ad21cab2e54d3","embed_id":"511633"};
                  var d = document;
       ...
       <!-- cards articles -->
        <div class="col-12 col-lg-6 col-xl-7 order-md-2 pe-5 ps-0">
          <div class="row responsive1">                       
              ...
              <div class="card box-Sha full" style="width: 20rem; border: none;">
                ...
                <div class="card-body p-1">
                  <div class=" card-text d-flex justify-content-between">
                    <div>
                      <span class="fs-3 fw-bold">11 €  </span>  <br><p class="gray">  Maison du Monde </p>
                    </div>
            ...
            <div class="col-12 col-xl-6 col-xxl-4 mb-3 d-flex justify-content-evenly">
              <div class="card box-Sha full" style="width: 20rem; border: none;">
            ...
            <div class="col-12 col-md-6 col-xxl-4 d-flex justify-content-center mb-3">
              <div class="card box-Sha full" style="width: 20rem; border: none;">
              ...
              <div class="card " >
                ...
                <div class="card-body m-2 p-1">
                  ...
                  <div class="card-text">
                    ...
                    <p class="text-muted float-end mb-0 " >Colomiers<p>
                  </div>                    
                </div>
              </div>
            </div>
            ...
            <div class="ms-2 me-2 box-Sha full">
              <div class="card" >
                ...
                <div class="card-body m-2 p-1">
                  ...
                  <div class="card-text">
                    <p style="color: #58b58d; font-weight:500">table • bureau • +1 article</p>
                    <p class="text-muted float-end mb-0 " >Toulouse<p>
                  </div>                    
                </div>
              </div>
            </div>
            ...
            <div class="ms-2 me-2 box-Sha full">
              <div class="card " >
                ...
                <div class="card-body m-2 p-1">
                  ...
                  <div class="card-text">
                    <p style="color: #58b58d; font-weight:500">table • bureau • +1 article</p>
                    <p class="text-muted float-end mb-0 " >Muret<p>
                  </div>                    
                </div>
              </div>
            </div>
            ...
            <div class="ms-2 me-2 box-Sha full">
              <div class="card" >
                ...
                <div class="card-body m-2 p-1">
                  ...
                  <div class="card-text">
                    <p style="color: #58b58d; font-weight:500">table • bureau • +1 article</p>
                    <p class="text-muted float-end mb-0 " >Valparaiso<p>
                  </div>                    
                </div>
              </div>
            </div>
            ...
            <div class="ms-2 me-2 box-Sha full">
              <div class="card" >
                ...
                <div class="card-body m-2 p-1">
                  ...
                  <div class="card-text">
                    <p style="color: #58b58d; font-weight:500">table • bureau • +1 article</p>
                    <p class="text-muted float-end mb-0 " >Paris<p>
                  </div>                    
                </div>
              </div>
            </div>
            ...
            <div class="ms-2 me-2 box-Sha full">
              <div class="card" >
                ...
                <div class="card-body m-2 p-1">
                  ...
                  <div class="card-text">
                    <p style="color: #58b58d; font-weight:500">table • bureau • +1 article</p>
                    <p class="text-muted float-end mb-0 " >Marseille<p>
                  </div>                    
                </div>
              </div>
            </div>
